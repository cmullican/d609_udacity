...
'''
SharewithResearch_node1743978385261 = sparkSqlQuery(glueContext, query = SqlQuery4972, mapping = {"myDataSource":CustomerLanding_node1743978218276}, transformation_ctx = "SharewithResearch_node1743978385261")
...
CustomerTrusted_node1743978617546 = glueContext.getSink(path="s3://cmulli/customer/trusted/", connection_type="s3", updateBehavior="LOG", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerTrusted_node1743978617546")
