...
accelerometertrusted_node1743987480878 = glueContext.getSink(path="s3://cmulli/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="accelerometertrusted_node1743987480878")
accelerometertrusted_node1743987480878.setCatalogInfo(catalogDatabase="stedi",catalogTableName="accelerometer_trusted")
accelerometertrusted_node1743987480878.setFormat("json")
accelerometertrusted_node1743987480878.writeFrame(filter_node1743987255288)
job.commit()